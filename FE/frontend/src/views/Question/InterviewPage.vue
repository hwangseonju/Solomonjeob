          ...
          <div id="main-container" class="container">
            <div id="session" v-if="session && !selected">
              ...
              <div>
                ...
                <input class="btn" type="button" id="copybtn" @click="copyURL" value="복사" />
              </div>
              ...
              <div>
                <span v-if="this.checkVideo"
                  ><i @click="this.togglepublisherVideo" class="fas fa-video-slash"></i
                ></span>
                <span v-else><i @click="this.togglepublisherVideo" class="fas fa-video"></i></span>

                <br />
                <span v-if="this.audioActive"
                  ><i @click="this.togglepublisherAudio" class="fas fa-volume-up"></i
                ></span>

                <span v-else
                  ><i @click="this.togglepublisherAudio" class="fas fa-volume-mute"></i
                ></span>
              </div>
            </div>
            <div v-if="selected">
